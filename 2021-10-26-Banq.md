...
<figure>
  <img src="{{ '/banq-mw.jpg' | relative_url }}" alt="Newspaper spread"/>
...
<figure class="figure float-right" style="margin-left: 1em">
  <img src="/banq-patrie.jpg" class="figure-img img-fluid rounded" alt="Cover of La Patrie Newspaper" width="350px">
